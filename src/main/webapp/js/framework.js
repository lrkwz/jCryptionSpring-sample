...
var encryptedSurname = "";
var encryptedName = "";
var encryptedPassword = "";
var encryptedEmailAddress = "";
var encryptedCellPhone = "";
...
/**
 * Called on profile submit
 */
function onSubmitSecureUserProfile() {
	var surname = $("#_surname_id").val();
	var name = $("#_name_id").val();
	var password = $("#_password_id").val();
	var emailAddress = $("#_emailAddress_id").val();
	var cellPhone = $("#_cellPhone_id").val();
	
	$.jCryption.encrypt(surname, keys, function(e1) {
		encryptedSurname = e1;
		alert( "surname=" + encryptedSurname + " name=" + encryptedName + " password=" + encryptedPassword + " email=" + encryptedEmailAddress + " cellphone=" + encryptedCellPhone);
		$.jCryption.encrypt(name, keys, function(e2) {
			encryptedName = e2;
			alert( "surname=" + encryptedSurname + " name=" + encryptedName + " password=" + encryptedPassword + " email=" + encryptedEmailAddress + " cellphone=" + encryptedCellPhone);
			$.jCryption.encrypt(password, keys, function(e3) {
				encryptedPassword = e3;
				alert( "surname=" + encryptedSurname + " name=" + encryptedName + " password=" + encryptedPassword + " email=" + encryptedEmailAddress + " cellphone=" + encryptedCellPhone);
				$.jCryption.encrypt(emailAddress, keys, function(e4) {
					encryptedEmailAddress = e4;
					alert( "surname=" + encryptedSurname + " name=" + encryptedName + " password=" + encryptedPassword + " email=" + encryptedEmailAddress + " cellphone=" + encryptedCellPhone);
					$.jCryption.encrypt(cellPhone, keys, function(e5) {
						encryptedCellPhone = e5;
						alert( "surname=" + encryptedSurname + " name=" + encryptedName + " password=" + encryptedPassword + " email=" + encryptedEmailAddress + " cellphone=" + encryptedCellPhone);
//						//submitSecureUserProfile();
					});
				});
			});
		});
